<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="documentList.aspx.cs" Inherits="view.documentList" %>
...
<body>
    <div class="container">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbar-collapse-1">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="javascript:;">文档下载</a></li>
        ...
        <div class="panel panel-default" style="margin-top: 20px">
            <div class="panel-heading">文档下载<span style="float:right">共 <%=tempCount %> 条记录</span></div>
            <%=sbHTML2 %>
        </div>
...
<script type="text/javascript">
    ...
    var doSignin = function () {
        window.location.href = "/signin.aspx?from=documentList";
    };

    var doRegister = function () {
        window.location.href = "/register.aspx?from=documentList";
    };
