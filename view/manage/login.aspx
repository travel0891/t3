    ...
    <div class="t_form">
        ...
        <form id="tempForm" onsubmit="return false">
            <div class="input-group form-group">
                ...
                <input type="text" name="name" class="form-control" placeholder="请输入账号" maxlength="8" value="<%=name %>" />
            </div>
            <div class="input-group form-group">
                <span class="input-group-addon"><span class="glyphicon glyphicon-lock"></span></span>
                <input type="password" name="password" class="form-control" placeholder="请输入密码" maxlength="12" value="<%=password %>" />
            </div>
            <div class="form-group">
                <div class="checkbox">
                    <label class="color999">
                        <input type="checkbox" name="keepLine" <%=keep %> />记住账号密码
                    </label>
                </div>
            </div>
            <div class="form-group">
