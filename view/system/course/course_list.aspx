<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="course_list.aspx.cs" Inherits="view.course_list" %>


<!doctype html>
<html>
<head>
    <title>课件列表 - <%=WebsiteTitle %></title>
...
<body>
    <div class="container-fluid mt15">
        <ol class="breadcrumb"><li class="c999">当前：课件管理</li><li class="c999">课件列表</li></ol>
    ...
    <script type="text/javascript">
        ...
        var del = function (indexCharId) {
            if (confirm("确定继续删除？"))
                $.ajax({
                    url: "/action.ashx?type=delStudent",
                    type: "post",
