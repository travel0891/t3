      ...
      <ol class="breadcrumb">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label">
                密码</label>
            <div class="col-sm-5">
                <input type="text" id="password" class="form-control" maxlength="12" placeholder="必填" runat="server" />
            </div>
        </div>
        <div class="form-group">
            <label class="col-sm-1 control-label">
        ...
        <div class="form-group">
            <label class="col-sm-1 control-label">
                班级</label>
            <div class="col-sm-5">
                <input type="text" id="classes" class="form-control" placeholder="必填" runat="server" />
            </div>
        </div>
        <div class="form-group">
