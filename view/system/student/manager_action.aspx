<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="manager_action.aspx.cs" Inherits="view.manager_action" %>
<!doctype html>
<html>
<head>
    <title>管理员<%=String.IsNullOrEmpty(Request.QueryString["charId"])?"添加":"编辑" %> - <%=WebsiteTitle %></title>
...
<body>
    <div id="formList" class="container-fluid mt15">
      <ol class="breadcrumb">
            <li class="c999">当前：用户管理</li><li class="c999">管理员<%=String.IsNullOrEmpty(Request.QueryString["charId"])?"添加":"编辑" %></li>
        </ol>
        ...
        <div class="form-group" style="display:none">
            <label class="col-sm-1 control-label">
                学号</label>
            <div class="col-sm-5">
                <input type="text" id="number" value="-" class="form-control" placeholder="必填" runat="server" />
            </div>
        </div>
        <div class="form-group" style="display:none">
            <label class="col-sm-1 control-label">
                姓名</label>
            <div class="col-sm-5">
                <input type="text" id="name" value="-" class="form-control" placeholder="必填" runat="server" />
            </div>
        </div>
        <div class="form-group" style="display:none">
            <label class="col-sm-1 control-label">
        ...
        <div class="form-group" style="display:none">
            <label class="col-sm-1 control-label">
                班级</label>
            <div class="col-sm-5">
                <input type="text" id="classes" class="form-control" value="-" placeholder="必填" runat="server" />
            </div>
        </div>
        <div class="form-group" style="display:none">
            <div class="col-sm-offset-1 col-sm-5">
                <div class="checkbox">
                    <label>
                        <input name="super" type="checkbox" checked="checked" />设置为管理员
                    </label>
                </div>
            </div>
        </div>
        <div class="form-group">
            <div class="col-sm-offset-1 col-sm-5">
                <button type="submit" id="managerSubmit" class="btn btn-primary"><%=String.IsNullOrEmpty(Request.QueryString["charId"])?"保存":"更新" %></button>
