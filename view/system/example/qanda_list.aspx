<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="qanda_list.aspx.cs" Inherits="view.qanda_list" %>

<!doctype html>
<html>
<head>
    <title>问答题列表 - <%=WebsiteTitle %></title>
...
<body>
    <div class="container-fluid mt15">
        <ol class="breadcrumb"><li class="c999">当前：试题管理</li><li class="c999">问答题列表</li></ol>
